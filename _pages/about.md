...
# 🔥 News
- *2023.08*: &nbsp;🎉🎉 Organized an invited session for [2023 IEEE CDC, Singapore](https://cdc2023.ieeecss.org/), titled "Computational Techniques for Automation in Power and Energy Systems", together with Yuning Jiang (EPFL), Enrique Mallada (John Hopkins), Colin Jones (EPFL), Gabriela Hug (ETH Zurich), and John Lygeros (ETH Zurich). See you all in Singapore.
  
# 📝 Publications 

## Optimal Power Flow

<div class='paper-box'><div class='paper-box-image'><div><div class="badge">TPWRS 2019</div><img src='images/500x300.png' alt="sym" width="100%"></div></div>
